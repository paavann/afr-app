    ...
    <header className="glass sticky top-0 z-50 px-6 py-3">
      ...
      <div className="flex items-center justify-between max-w-[1800px] mx-auto">
        ...
        <div className="flex items-center gap-3">
          {/* Logo icon */}
          <div className="relative w-9 h-9 rounded-lg bg-gradient-to-br from-accent-primary to-accent-bright flex items-center justify-center shadow-lg shadow-accent-glow">
        ...
        {/* Center: File info */}
        {fileName && (
          <div className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-dark-700/60 border border-dark-500/40">
        ...
        <div className="flex items-center gap-4">
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium ${currentStatus.color}`}>
            <span className={`w-2 h-2 rounded-full ${currentStatus.dot} ${status === 'processing' || status === 'uploading' ? 'animate-pulse' : ''}`} />
